package org.usfirst.frc.team319.lib.motion;
...
public class ProfileFollower {
     ...
     * update() will be used rather than feeding forward the previous setpoint the
     * next time update() is called. This almost always forces a MotionProfile
     * update, and may be warranted if tracking error gets very large.
     */
     ...
     * that this does not check whether we are anywhere close to the final setpoint,
     * however.
     *
     ...
     * of achievement depends on the goal's completion behavior).
     *
    ...
    public boolean onTarget() {
        ...
        // For the options that don't achieve the goal velocity exactly, also count any
        // instance where we have passed
        // the finish line.
