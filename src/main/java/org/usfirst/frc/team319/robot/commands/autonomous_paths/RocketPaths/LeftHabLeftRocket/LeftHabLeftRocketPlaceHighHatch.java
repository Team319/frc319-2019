...
import org.usfirst.frc.team319.robot.commands.Elevator_Commands.ElevatorGoToHighHatchPosition;
...
public class LeftHabLeftRocketPlaceHighHatch extends CommandGroup {

  public LeftHabLeftRocketPlaceHighHatch() {
    addParallel(new ElevatorGoToHighHatchPosition());
